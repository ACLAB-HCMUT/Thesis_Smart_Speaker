...
#define EI_CLASSIFIER_TFLITE_LEARN_7_ARENA_SIZE     10624
const size_t tflite_learn_7_arena_size = 10624;

INCBIN(incbin_tflite_learn_7, "tflite-model/tflite_learn_7.tflite");

const unsigned char *tflite_learn_7 = gincbin_tflite_learn_7_data;
unsigned int tflite_learn_7_len = gincbin_tflite_learn_7_size;
